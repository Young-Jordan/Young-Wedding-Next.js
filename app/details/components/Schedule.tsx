    ...
    <section className="flex snap-center min-h-screen flex-col items-center justify-center lg:gap-y-12">
      <div className="flex flex-col items-center mt-20 mb-14 lg:p-0 px-6 relative">
        ...
        <Accordion className="lg:w-1/2 w-full max-w-4xl border-accent bg-white border-4 rounded-lg px-6">
          ...
          >
            <div className="font-serif py-6">
              The henna ceremony will be held on saturday as a brunch, starting
              at noon. This event is an intimate gathering, and as such,
          ...
          <AccordionItem className="py-6" title={"Sunday November 17th"}>
            <div className="font-serif py-6">
              Our matrimonial ceremony will be hosted at the elegant Bordone
              LIC. The festivities will commence at 2:00pm in the gentle glow of
              the afternoon sun, followed by a delightful cocktail hour that
              gracefully transitions into the evening reception. We look forward
              to celebrating this joyous occasion with you.
            </div>
          </AccordionItem>
        </Accordion>
