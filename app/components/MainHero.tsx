  ...
  <section className="snap-center grid grid-rows-3 h-screen min-h-screen items-center text-center justify-center lg:p-24 lg:pb-12 p-5 lg:gap-y-12">
    <div className="relative flex flex-col gap-y-12 lg:mt-0 mt-[25%] items-center row-start-2">
      <div className="relative">
        ...
        <h1 className="font-sans flex flex-col lg:flex-row items-center relative z-10 lg:text-7xl text-5xl leading-relaxed lg:m-0 mt-auto">
          <span className="mb-10">Jordan</span>
          <span>
            <Image
              alt="rings"
              className="mx-16 lg:mt-6 lg:w-auto w-52"
              width={250}
              src={ring}
            />
          </span>
      ...
      <div className="flex gap-x-4">
        <Appear>
          <Link
            href={"/rsvp"}
            className="outline-accent outline text-accent rounded-full w-fit uppercase px-6 py-3 text-lg tracking-widest hover:outline-0 hover:text-white hover:bg-black transition-colors"
          >
            Click to RSVP
          </Link>
        </Appear>
